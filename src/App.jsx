  ...
  return (
    <>
      ...
      <div className="title-section text-center mt-10 mb-10">
        <h1 className="page-title h-auto max-md:top-[200px] max-md:right-[250px] max-md:w-[375px]">
      ...
      {/* === Programme === */}
      <h1 className="page-title mt-10 h-auto max-md:top-[200px] max-md:right-[250px] max-md:w-[375px]">
        Le Programme
      </h1>
      ...
      <section className="extras relative text-center mt-16 mb-20">
        ...
        />
        <h1 className="page-title mt-6 h-auto max-md:top-[200px] max-md:right-[250px] max-md:w-[375px]">À propos</h1>
