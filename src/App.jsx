  ...
  return (
    <>
      ...
      <div className="title-section text-center mt-10 mb-10">
        <h1 className="page-title h-auto max-md:top-[200px] max-md:right-[250px] max-md:w-[400px]">
      ...
      {/* === Programme === */}
      <h1 className="page-title mt-10 h-auto max-md:top-[200px] max-md:right-[250px] max-md:w-[400px]">
        Le Programme
      </h1>
      ...
      <section className="programmes flex flex-wrap justify-center mt-8">
        <img
          ...
          alt="Programme 1"
          className="w-full sm:w-[45%] md:w-[300px] lg:w-[400px] xl:w-[600px] h-auto rounded-xl transition-transform duration-300 ease-in-out"
        />
        <img
      ...
      <section className="extras relative text-center mt-16 mb-20">
        <img
          src={RectangleCircles}
          alt="rect"
          className="block w-[98%] mx-auto h-auto"
        />
        <h1 className="page-title mt-6 h-auto max-md:top-[200px] max-md:right-[250px] max-md:w-[400px]">À propos</h1>
        ...
        <div className="relative flex flex-col items-center text-center ml-[10px] max-md:mt-[80px]">
          <h1 className="contact-texte1 text-base max-sm:text-sm sm:text-lg md:text-2xl lg:text-2xl xl:text-3xl lg:text-2xl">
            Nous contacter : - Mail : maxime.georges056@gmail.com
          </h1>
          <h1 className="contact-texte2 text-base max-sm:text-sm text-base sm:text-lg md:text-2xl lg:text-2xl xl:text-3xl mr-[105px] mt-[10px] max-md:translate-x-[28px]">
            - Réseaux : DM
          </h1>
        </div>
        <img
          src={CirclesTriangle}
          alt="Triangle"
          className="absolute top-[60px] left-[1350px] w-[560px] h-auto max-md:top-[145px] max-md:left-[250px] max-md:w-[150px]"
        />
      </section>
    </>
  );
